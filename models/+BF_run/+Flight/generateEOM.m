% System: bipedal robot with SingleStance and Flight Phases
% Phase now: Flight
...
%% Summary of positons
% CoGs (incl orientation of the segments) [3*5]:
...
matlabFunction(event_td, 'File', fullfile(['+', packageNames{1}], 'event'), 'Vars', {X_f, u, p});
